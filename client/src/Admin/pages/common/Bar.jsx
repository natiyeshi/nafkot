  ...
  return (
    <div className='relative basis-3/12  h-screen bg-white pt-4 '>
          ...
          <div className='mt-7 flex flex-col gap-1'>
              ...
              <NavLink to={"/admin/dashbord"} className={`${path == "/admin/dashbord" && "bg-red-400 bg-opacity-20 "} relative group ps-10 transition  duration-200 flex font-bold hover:bg-red-400 hover:bg-opacity-20 cursor-pointer gap-5 px-4 py-3`}>
              ...
              <NavLink to={"/"} onClick={()=>localStorage.setItem("admin-token","")} className={`${path == "/admin/logout" && "bg-red-400 bg-opacity-20 "} relative group ps-10 transition  duration-200 flex font-bold hover:bg-red-400 hover:bg-opacity-20 cursor-pointer gap-5 px-4 py-3`}>
