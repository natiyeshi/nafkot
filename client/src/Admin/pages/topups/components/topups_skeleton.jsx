...
const TopupSkeleton = () => {
  return (
 <div className='bg-gray-50 relative  pt-2 w-full duration-300  rounded shadow-md border   shrink-0'>
        ...
        <div className='mx-4 flex my-2 gap-10  bg-gray-30 w-10/12     ' >
            <button className='bg-gray-400  duration-300 rounded px-6 py-[9px] font-bold text-white'></button>
