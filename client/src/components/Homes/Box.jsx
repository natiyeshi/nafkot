...
const Box = () => {
  return (
    <div className='border rounded hover:shadow-2xl hover:shadow-slate-500 duration-200 hover:-translate-y-1 '>
        ...
        <div className='flex justify-between mt-2 text-large'>
            ...
            <button className='grow py-2 text-center font-semibold duration-100 bg-redd hover:bg-red-400 text-white rounded-tl'>Add to cart</button>
        </div>
