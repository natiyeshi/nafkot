  ...
  return (
    <div className={" rounded h-fit  duration-200 "}>
      ...
      <div className="w-full text-center my-1">
        ...
        <p className={'rounded py-2 my-1 ' +css.element}></p>
      </div>

      <div className="flex mt-2 text-large gap-3">
        <div className={"grow py-2 text-center my-1 font-bold " + css.element}></div>
        <div
          className={"grow py-2 text-center font-semibold duration-100  my-1 " + css.element}
        >
        </div> 
        <div className={"grow py-2 text-center font-semibold duration-100 my-1  text-white rounded " + css.element}>
        </div>
      </div>
    </div>
  );
