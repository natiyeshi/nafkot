...
const Testimonial = () => {
  return (
    <div className='relative px-c14 max-md:px-2 bg-gray-100 mx-auto pb-10'>
            
        <h1 className='py-3 text-center text-xl mt-10 mb-5 font-semibold capitalize'>customers review</h1>

        <div className='absolute max-md:hidden h-full left-0 bottom-0 bg-gradient-to-r from-gray-100 via-gray-100 w-2/6'></div>
        <div className='absolute max-md:hidden right-0 h-full bottom-0 bg-gradient-to-l from-gray-100 via-gray-100 w-2/6'></div>

        <div className=' flex overflow-auto  py-3 gap-2 testimonial-scroll z-50 mb-3'>
            
            <div className='max-md:hidden flex-shrink-0 p-2 px-3 flex flex-col basis-2/12 gap-2 rounded-sm'>
            ...
            <div className='max-md:hidden flex-shrink-0 p-2 px-3 flex flex-col basis-1/3 gap-2 rounded-sm'>
