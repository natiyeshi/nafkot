...
const FormDiv = () => {
    ...
    const intialFormData = {
      ...
      senderFirstName : "",senderLastName : "", senderEmail : "",senderPhoneNumber: "",
      reciverFirstName : "" , reciverLastName : "",reciverEmail : "",
      reciverPhoneNumber : "", reciverPhoneNumber2 : "", reciverCity : "", 
      reciverRegion : "", message : "", cart 
    }
    ...
    return (
        <form className=' px-4'
            ...
            <div className='flex gap-10 max-md:gap-3 max-md:flex-col ps-4 py-2 justify-around '>
                ...
                <CustomeInput name={"senderLastName"}
                    label={"Last Name"}
                    onChangeFunc={onChangeFunc}/>
            ...
            <div className='flex max-md:gap-3 max-md:flex-col ps-4 py-2 justify-around gap-10'>
                ...
                <CustomeInput name={"senderPhoneNumber"}
                    label={"Phone Number"}
                    onChangeFunc={onChangeFunc}/>
            ...
            <div className='flex max-md:gap-3 max-md:flex-col ps-4 py-2 justify-around gap-10'>
                ...
                <CustomeInput name={"reciverFirstName"}
                    ...
                    onChangeFunc={onChangeFunc}/>
                <CustomeInput name={"reciverLastName"}
            ...
            <div className='flex max-md:gap-3 max-md:flex-col ps-4 py-2 justify-around gap-10'>
                ...
                <CustomeInput name={"reciverPhoneNumber"}
                    ...
                    onChangeFunc={onChangeFunc}/>
                <CustomeInput name={"reciverPhoneNumber2"}
            ...
            <div className='flex ps-4 max-md:gap-3 max-md:flex-col py-2 justify-around gap-10'>
                ...
                <CustomeInput name={"reciverRegion"}
            ...
            <div className='flex ps-4 py-2 max-md:gap-3 max-md:flex-col justify-around gap-10'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <textarea onChange={onChangeFunc} type="text" name='message' placeholder='message' className='w-full resize-none focus:outline-none border border-gray-300 p-2 rounded-md'/>
                </div>
